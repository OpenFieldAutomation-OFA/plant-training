...
test_dataloader = dict(
    ...
    dataset=dict(
        ann_file='annnotation/caw_maize_test.txt',
        data_prefix='/mnt/c',
        pipeline=[
...
test_evaluator = [
    ...
    dict(average=None, type='SingleLabelMetric'),
    dict(class_id=1, type='BinaryMetric'),
]
test_pipeline = [
    dict(type='LoadImageFromFile'),
    dict(
...
train_dataloader = dict(
    batch_size=1024,
    dataset=dict(
        ann_file='annnotation/plantclefleafcaw_maize_train.txt',
        data_prefix='/mnt/c',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
...
val_dataloader = dict(
    batch_size=1024,
    dataset=dict(
        ann_file='annnotation/plantclefleafcaw_maize_val.txt',
        data_prefix='/mnt/c',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
...
work_dir = './work_dirs/plantclefleafcaw_maize'

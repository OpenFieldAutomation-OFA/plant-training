...
launcher = 'none'
load_from = '/mnt/data/saved/20240625_095837_plantclef.pth'
log_level = 'INFO'
model = dict(
    backbone=dict(
        arch='base',
...
test_dataloader = dict(
    ...
    dataset=dict(
        ann_file='annotation/plantclef_test.txt',
...
train_dataloader = dict(
    batch_size=1024,
    dataset=dict(
        ann_file='annotation/plantclef_train.txt',
        data_prefix='/mnt/data',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(

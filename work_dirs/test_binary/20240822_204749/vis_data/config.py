...
launcher = 'none'
load_from = 'work_dirs/finetune/epoch_5.pth'
log_level = 'INFO'
model = dict(
    backbone=dict(
        arch='dinov2-small',
        ...
        init_cfg=dict(
            checkpoint=
            'https://download.openmmlab.com/mmpretrain/v1.0/dinov2/vit-small-p14_dinov2-pre_3rdparty_20230426-5641ca5a.pth',
            prefix='backbone',
            type='Pretrained'),
...
test_evaluator = dict(
    class_ids=[
        2354,
    ], increase_output=0.15, type='BinaryMetric')
test_pipeline = [
    dict(type='LoadImageFromFile'),
    dict(
        backend='pillow',

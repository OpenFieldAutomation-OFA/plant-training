...
launcher = 'none'
load_from = '/mnt/data/saved/20240623_200625_caw.pth'
log_level = 'INFO'
model = dict(
    backbone=dict(
        arch='base',
...
test_evaluator = dict(class_id=2473, thrs=0.0, type='BinaryMetric')
test_pipeline = [
    dict(type='LoadImageFromFile'),
    dict(
        backend='pillow',
...
val_dataloader = dict(
    ...
    persistent_workers=True,
    sampler=dict(shuffle=True, type='DefaultSampler'))
val_evaluator = dict(class_id=2473, type='BinaryMetric')
vis_backends = [
